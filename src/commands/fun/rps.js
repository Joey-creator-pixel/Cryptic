...
module.exports = class RockPaperScissorsCommand extends Command {
  ...
  run(message, args) {
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**Cryptic** wins!';
    else result = `**${message.member.displayName}** wins!`;
    const embed = new MessageEmbed()
      .setTitle(`${message.member.displayName} vs. Cryptic`)
      .addField('Your Choice:', res[userChoice], true)
      .addField('Cryptic\'s Choice', res[botChoice], true)
